...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    return "green" if percentage >= 80 else "orange" if percentage >= 60 else "red" if percentage >= 30 else "black"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    return "LOW" if temp_neut < threshold * 0.9 else "NORMAL" if temp_neut <= threshold * 1.1 else "DANGER"